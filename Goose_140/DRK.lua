...
profile.Sets = {
    Idle_Priority = {
        Head = {'Cmp. Eye Circlet', 'Cotton Headband', 'Bastokan Cap'}

    },
    TP_Priority = {
        Head = {'Voyager Sallet', 'Empress Hairpin', 'Emperor Hairpin', 'Bastokan Visor', 'Centurion\'s Visor'},
